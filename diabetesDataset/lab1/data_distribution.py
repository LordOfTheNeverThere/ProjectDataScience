...
tight_layout()
savefig('images/distribution/outliers.png')
...
for n in range(len(numeric_vars)):
    ...
    i, j = (i + 1, 0) if (n+1) % cols == 0 else (i, j + 1)
savefig('images/distribution/single_histograms_numeric.png', dpi = 450)
show()
...
savefig('images/distribution/single_histograms_binary.png', dpi = 450)
show()
...
for n in range(len(numeric_vars)):
    ...
    i, j = (i + 1, 0) if (n+1) % cols == 0 else (i, j + 1)
savefig('images/distribution/histograms_trend_numeric.png')
...
tight_layout()
savefig('images/distribution/histograms_symbolic.png')
show()
# %%
