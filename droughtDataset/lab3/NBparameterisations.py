...
train: DataFrame = read_csv(f'../Data/TrainTest/{filename}_train.csv')
trnY: ndarray = train.pop(target).values
trnX: ndarray = train.values
labels = unique(trnY)
labels.sort()

test: DataFrame = read_csv(f'../Data/TrainTest/{filename}_test.csv')
...
savefig(f'images/NB/{file_tag}_nb_best.png')
show()

# accurady of different parameterisations
