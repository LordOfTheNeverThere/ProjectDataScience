...
for path in list:
    ...
    train: DataFrame = read_csv(path)
    trnY: ndarray = train.pop(target).values
    trnX: ndarray = train.values
    labels = unique(trnY)
    labels.sort()

    test: DataFrame = read_csv(f'../TrainTest/drought_prepared_train.csv')
    ...
    savefig(f'../../lab3/images/KNN/{file}_knn_study.png')
    show()
    ...
    savefig(f'../../lab3/images/KNN/{file}_knn_best.png')
    show()
    ...
    #     savefig('../../lab3/images/KNN/overfitting_{name}_{file}.png')
