...
# plot_series(train[target_multi], title=f'{target_multi} - Differentiation 0', x_label=index_multi, y_label='value')
# xticks(rotation = 45)
# savefig(f'images/differentiation/set2_data_differentiation_0.png')
# show()
#
# diff1_df_multi = train.diff()
...
# xticks(rotation = 45)
# savefig(f'images/differentiation/set2_data_differentiation_1.png')
# show()
#
...
# xticks(rotation = 45)
# savefig(f'images/differentiation/set2_data_differentiation_2.png')
# show()
...
for w in range(3):
    train = read_csv(f'../Data/TimeSeries/Differentiation/{file_tag}_Differentiation_{w}.csv', index_col="date", sep=',', decimal='.', parse_dates=True, dayfirst=True)
    ...
    savefig(f'images/differentiation/set2_train_differentiation_{w}_results.png')
    ...
    savefig(f'images/differentiation/set2_train_differentiation_{w}_plots.png')
