...
savefig(f'images/DecisionTrees/DT_approaches_Set2_Select.png')
show()
...
# show()
# savefig(f'images/DecisionTrees/DT_best_tree_C2_Set_Select.png')
...
savefig(f'images/DecisionTrees/{file_tag}_dt_variable_ranking_select.png')
#show()
...
savefig(f'images/DecisionTrees/{file_tag}_overfitting_select.png')
#show()
